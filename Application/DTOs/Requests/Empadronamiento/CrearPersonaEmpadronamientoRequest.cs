...
{
    // 🔥 Se agrega el Id opcional para saber si es actualización
    ...
    /// <summary>
    /// Observaciones dentro del empadronamiento (tabla intermedia)
    /// </summary>
    ...
    public CrearDireccionRequest? Direccion { get; set; } 
